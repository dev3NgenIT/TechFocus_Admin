...
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-12 text-lg-center text-sm-center">
                                    <div class="card-title table_title">
                                        <h2 class="text-center">Policy Acknowledgments</h2>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-12 text-lg-end text-sm-center">
                                    ...
                                    <button type="button" class="btn btn-sm btn-light-success rounded-0"
                                        ...
                                        data-bs-target="#policyAcknowledgementsAddModal">
                                        Add New
                                    </button>
                                ...
                                <tr class="odd">
                                    ...
                                    <td class="d-flex justify-content-between align-items-center">
                                        <a href="#"
                                            ...
                                            data-bs-toggle="modal" data-bs-target="#policyAcknowledgementsViewModal">
                                            <i class="fa-solid fa-expand"></i>
                                        </a>
                                        <a href="#"
                                            class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                            data-bs-toggle="modal" data-bs-target="#policyAcknowledgementsmentEditModal">
    ...
    {{-- Add Modal --}}
    <div class="modal fade" id="policyAcknowledgementsAddModal" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-0 border-0 shadow-sm">
                <div class="modal-header p-2 rounded-0">
                    <h5 class="modal-title ps-5">Add Policy Acknowledgments</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <select class="form-select form-select-solid form-select-sm" name="country_id"
                                                data-dropdown-parent="#policyAcknowledgementsAddModal"
                                        ...
                                        <div class="col-md-6 mb-2">
                                            <label for="validationCustom04" class="form-label required mb-0">Policy
                                                Name</label>
                                            <select class="form-select form-select-solid form-select-sm" name="policy_id"
                                                data-dropdown-parent="#policyAcknowledgementsAddModal"
                                                data-control="select2" data-placeholder="Select an option"
                                                data-allow-clear="true" required>
                                                <option></option>
                                        ...
                                        <div class="col-md-12 mb-1">
                                            <label for="validationCustom01" class="form-label required mb-0">Sign
                                            </label>
                                            <input type="file" class="form-control form-control-solid form-control-sm"
                                                name="sign" id="validationCustom01" placeholder="Choose Sign" required>
                                            <div class="invalid-feedback"> Please Choose Sign </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    {{-- Edit Modal --}}
    <div class="modal fade" id="policyAcknowledgementsmentEditModal" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-0 border-0 shadow-sm">
                <div class="modal-header p-2 rounded-0">
                    <h5 class="modal-title ps-5">Edit Policy Acknowledgments</h5>
                    <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal"
                        aria-label="Close">
                        <i class="fa-solid fa-circle-xmark"></i>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            <label for="validationCustom04" class="form-label required mb-0">Country
                                                Name</label>
                                            <select class="form-select form-select-solid form-select-sm" name="country_id"
                                                data-dropdown-parent="#policyAcknowledgementsmentEditModal"
                                                data-control="select2" data-placeholder="Select an option"
                                                data-allow-clear="true" required>
                                                <option></option>
                                                <option value="1">Bangaldesh</option>
    ...
    {{-- View Modal --}}
    <div class="modal fade" id="policyAcknowledgementsViewModal" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-0 border-0 shadow-sm">
                <div class="modal-header p-2 rounded-0">
                    <h5 class="modal-title ps-5">View Policy Acknowledgments</h5>
                    <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal"
                        aria-label="Close">
                        <i class="fa-solid fa-circle-xmark"></i>
                    </div>
