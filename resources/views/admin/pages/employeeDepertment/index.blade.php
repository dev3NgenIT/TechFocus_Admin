...
@section('content')
                        ...
                        <table
                            ...
                            <thead class="table_header_bg">
                                ...
                                <tr class="text-center text-gray-900 fw-bolder fs-7 text-uppercase">
                                    ...
                                    <th class="" width="45%">Country Name</th>
                            ...
                            <tbody class="fw-bold text-gray-600 text-center">
                                <tr class="odd">
                                    ...
                                    <td class="d-flex justify-content-between align-items-center">
                                        ...
                                        <a href="#"
                                            class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1"
                                            data-bs-toggle="modal" data-bs-target="#employeeDepertmentEditModal">
                                            <!--begin::Svg Icon | path: icons/duotune/art/art005.svg-->
    ...
    {{-- Edit Modal --}}
    <div class="modal fade" id="employeeDepertmentEditModal" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-0 border-0 shadow-sm">
                <div class="modal-header p-2 rounded-0">
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="validationCustom04" class="form-label required">Country Name</label>
                                                <select class="form-select form-select-solid" name="country_id" 
                                                data-dropdown-parent="#employeeDepertmentEditModal"  data-control="select2" 
                                                data-placeholder="Select an option" data-allow-clear="true" required>
                                                  <option></option>
                                                  <option value="1">Option 1</option>
                                                  <option value="2">Option 2</option>
                                        ...
                                        <div class="col-md-6 mb-1">
                                            ...
                                            <input type="text" class="form-control form-control-solid form-control-sm"
                                                name="name" value="Ngen It" id="validationCustom01"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-6 col-sm-5">
                                                        <p class="fw-bold" title="Category Name">Coun Name</p>
                                                    </div>
