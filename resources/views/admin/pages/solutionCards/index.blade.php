...
@section('content')
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-12 text-lg-center text-sm-center">
                                    <div class="card-title table_title">
                                        <h2 class="text-center">Solution Cards</h2>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content rounded-0 border-0 shadow-sm">
                <div class="modal-header p-2 rounded-0">
                    <h5 class="modal-title ps-5">Add Solution Card</h5>
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-2">
                                            ...
                                            <input type="file" class="form-control form-control-solid form-control-sm"
                                                name="image" id="validationCustom01" placeholder="Enter Image"
                                                required>
                                            <div class="invalid-feedback"> Please Enter Image </div>
                                        </div>
                                        <div class="col-md-6 mb-2">
                                        ...
                                        <div class="col-md-12 mb-2">
                                            <label for="validationCustom01" class="form-label required mb-0">Short
                                                Des</label>
                                            <textarea name="short_des" class="tox-target kt_docs_tinymce_plugins"></textarea>
                                            <div class="invalid-feedback"> Please Enter Short Des </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="TermsPoliciesViewModal" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-0 border-0 shadow-sm">
                <div class="modal-header p-2 rounded-0">
                    <h5 class="modal-title ps-5">View Solution Card</h5>
                    <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal"
                        aria-label="Close">
                        <i class="fa-solid fa-circle-xmark"></i>
                    </div>
