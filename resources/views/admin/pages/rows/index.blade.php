                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-sm-12 text-lg-center text-sm-center">
                                <div class="card-title table_title">
                                    <h2 class="text-center">All Rows</h2>
                                </div>
                            </div>
                            <div class="col-lg-4 col-sm-12 text-lg-end text-sm-center">
                                ...
                                <a href="{{ route('rows.create') }}" type="button" class="btn btn-sm btn-light-success rounded-0">
                                    Add Row
                                </a>
                                <!--begin::Menu-->
                    ...
                    <table
                        ...
                        <thead class="table_header_bg">
                            ...
                            <tr class="text-center text-gray-900 fw-bolder fs-7 text-uppercase">
                                ...
                                <th class="" width="5%">Image</th>
                                <th class="" width="40%">Title</th>
                                <th class="" width="40%">List Title</th>
                        ...
                        <tbody class="fw-bold text-gray-600 text-center">
                            <tr class="odd">
                                ...
                                <td>Trusted by IT Teams Worldwide
                                </td>
                                <td>Revolutionizing Data Center Networking with NGenIT Solutions
                                </td>
