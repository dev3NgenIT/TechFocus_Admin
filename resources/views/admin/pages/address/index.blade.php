...
@section('content')
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-2">
                                            ...
                                            <select class="form-select form-select-solid form-select-sm" name="user_type"
                                                data-dropdown-parent="#addressAddModal" data-control="select2" data-hide-search="true"
                                                data-placeholder="Select an option" data-allow-clear="true" required>
                                                <option></option>
                                                <option value="1">Bangaldesh</option>
                                                <option value="2">India</option>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-2">
                                                    <label for="validationCustom04" class="form-label required mb-0">Country
                                                        Name</label>
                                                    <select class="form-select form-select-solid form-select-sm" name="country_id"
                                                        data-dropdown-parent="#addressEditModal" data-control="select2"
                                                        data-placeholder="Select an option" data-allow-clear="true" required>
                                                        <option></option>
                                                        <option value="1">Bangaldesh</option>
                                                        <option value="2">India</option>
                                                ...
                                                <div class="col-md-4 mb-2">
                                                    <label for="validationCustom04" class="form-label required mb-0">User Type</label>
                                                    <select class="form-select form-select-solid form-select-sm" name="user_type"
                                                        data-dropdown-parent="#addressEditModal" data-control="select2" data-hide-search="true"
                                                        data-placeholder="Select an option" data-allow-clear="true" required>
                                                        <option></option>
                                                        <option value="1">Bangaldesh</option>
                                                        <option value="2">India</option>
    ...
    {{-- View Modal --}}
    <div class="modal fade" id="addressViewModal" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content rounded-0 border-0 shadow-sm">
                <div class="modal-header p-2 rounded-0">
                    <h5 class="modal-title ps-5">View Address</h5>
                    <!-- Close button in the header -->
                    <div class="btn btn-icon btn-sm btn-active-light-primary ms-2" data-bs-dismiss="modal"
                        aria-label="Close">
                        <i class="fa-solid fa-circle-xmark"></i>
