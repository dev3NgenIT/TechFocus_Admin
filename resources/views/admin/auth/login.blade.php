                ...
                <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                    ...
                    <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
                        ...
                        <a href="../../demo1/dist/index.html" class="py-9 mb-5">
                            <img alt="Logo" src="{{asset('backend/assets/media/logos/logo-2.svg')}}" class="h-60px" />
                        </a>
                        <!--end::Logo-->
                        <!--begin::Title-->
                        <h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style="color: #986923;">Welcome to TechFocus Back Office</h1>
                        <!--end::Title-->
                    ...
                    <div class="d-flex flex-row-auto bgi-no-repeat bgi-position-x-center bgi-size-contain bgi-position-y-bottom min-h-100px min-h-lg-350px"
                        style="background-image: url('{{asset('backend/assets/media/illustrations/sketchy-1/13.png')}}')"></div>
                    <!--end::Illustration-->
                </div>
                <!--end::Wrapper-->
            </div>
                        ...
                        <form class="form w-100" novalidate="novalidate"method="POST" action="{{ route('admin.login') }}" >
                            ...
                            <div class="fv-row mb-10">
                                ...
                                <input class="form-control form-control-lg form-control-solid" type="email"
                                    name="identity" value="{{old('email')}}" required autocomplete="off" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
